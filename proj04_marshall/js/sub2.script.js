$(function () {
    ...
    //content acton
    var $acton = $('.acton'),
        $mnImgGroup = $acton.find('.mnImg .mnImgGroup'),
        $mnimage = $mnImgGroup.find('.image'),
        btPrev = $acton.find('.btPrev'),
        btNext = $acton.find('.btNext'),
        $thumImgGroup = $acton.find('.thumImg .thumImgGroup'),
        $thumImage = $acton.find('.thumImgGroup').children('.image');
